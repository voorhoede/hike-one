...
export default ({
	...
	<Head>
		...
		<link
			rel="icon"
			type="image/png"
			href="/static/icons/android-36x36.png"
			sizes="36x36"
		/>
		<link
			rel="icon"
			type="image/png"
			href="/static/icons/android-48x48.png"
			sizes="48x48"
		/>
		<link
			rel="icon"
			type="image/png"
			href="/static/icons/android-72x72.png"
			sizes="72x72"
		/>
		<link
			rel="icon"
			type="image/png"
			href="/static/icons/android-96x96.png"
			sizes="96x96"
		/>
		<link
			rel="icon"
			type="image/png"
			href="/static/icons/android-128x128.png"
			sizes="128x128"
		/>
		<link
			rel="icon"
			type="image/png"
			href="/static/icons/android-144x144.png"
			sizes="144x144"
		/>
		<link
			rel="icon"
			type="image/png"
			href="/static/icons/android-152x152.png"
			sizes="152x152"
		/>
		<link
			rel="icon"
			type="image/png"
			href="/static/icons/android-192x192.png"
			sizes="192x192"
		/>
		<link
			rel="icon"
			type="image/png"
			href="/static/icons/android-384x384.png"
			sizes="384x384"
		/>
		<link
			rel="icon"
			type="image/png"
			href="/static/icons/android-512x512.png"
			sizes="512x512"
		/>

		<link
			rel="apple-touch-icon"
			href="/static/icons/apple-60x60.png"
			sizes="60x60"
		/>
		<link
			rel="apple-touch-icon"
			href="/static/icons/apple-76x76.png"
			sizes="76x76"
		/>
		<link
			rel="apple-touch-icon"
			href="/static/icons/apple-120x120.png"
			sizes="120x120"
		/>
		<link
			rel="apple-touch-icon"
			href="/static/icons/apple-152x152.png"
			sizes="152x152"
		/>
		<link
			rel="apple-touch-icon"
			href="/static/icons/apple-180x180.png"
			sizes="180x180"
		/>
