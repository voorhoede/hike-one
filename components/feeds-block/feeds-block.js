...
const FeedsBlock = () => (
  <div className="feeds-block container">
    <div className="container-inner">
      ...
      />
      <EventsExtract subtitle={Data.eventsSubtitle} events={Data.events} link={Data.eventsLink} />
      <div className="feeds-link-container">
        <ButtonSecondaryLink href="/updates" icon="arrowRight" classes="btn-red-border feeds-link">
