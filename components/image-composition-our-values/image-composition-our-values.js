...
const ImageCompositionOurValues = ({children, TeamImage3_4, Person, ourValues}) => {
	const childrenArray = React.Children.toArray(children);
	const parallaxLayerFront = childrenArray.find(child => child.props.position === 'front');
	const parallaxLayerBack = childrenArray.find(child => child.props.position === 'back');

	return (
		<div className="image-composition image-composition-our-values clearfix">
			{parallaxLayerBack}
...
export default ImageCompositionOurValues;
