...
const MailchimpForm = ({ title='', description='', buttonLabel }) => (
  <div id="mc_embed_signup" className="mailchimp-form background-color">
    ...
    <form
      ...
      {/* <div id="mc_embed_signup_scroll" className="form"> */}
        ...
        <div className="clear btn-right-aligned"><input type="submit" value={buttonLabel} name="subscribe" id="mc-embedded-subscribe" className="button btn-primary submit-btn btn-large" /></div>
      {/* </div> */}
    </form>
  </div>
)
