  ...
  const style = {
    __html: `<style>
      .office-card .office-image-${index} {
        background-image: url('${setImageParams(imageUrl, { fit: 'crop', w: 465, h: 259 })}')
      }
      @media (min-width: 500px) {
        .office-card:first-child .office-image-${index} {
          background-image: url('${setImageParams(imageUrl, { fit: 'crop', w: 550,  h: 200 })}')
        }
      }
      @media (min-width: 768px) {
        .office-card .office-image-${index},
        .office-card:first-child .office-image-${index} {
          background-image: url('${setImageParams(imageUrl, { fit: 'crop', w: 310, h: 320 })}')
        }
      }
      @media (min-width: 1024px) {
        .office-card .office-image-${index},
        .office-card:first-child .office-image-${index} {
          background-image: url('${setImageParams(imageUrl, { fit: 'crop', w: 380, h: 491 })}')
        }
      }
    </style>`,
  }
