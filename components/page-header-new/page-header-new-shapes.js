...
export const ShapesDiamond = () => (
  <svg className="animated-shape" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1450 500">
    {/* <rect className="shape-bg" fill="#FE595B" fillRule="evenodd" width="100%" height="100%" x="0" y="0" /> */}
    <path className="shape-back" fill="#ff5c5c"  fillRule="evenodd" d="M725.05,249l.93.93a.07.07,0,0,1,0,.1l-.93.93a.07.07,0,0,1-.1,0l-.93-.93a.07.07,0,0,1,0-.1L725,249A.07.07,0,0,1,725.05,249Z" />
    <path className="shape-front" fill="#00aae9" fillRule="evenodd" d="M725.05,249l.93.93a.07.07,0,0,1,0,.1l-.93.93a.07.07,0,0,1-.1,0l-.93-.93a.07.07,0,0,1,0-.1L725,249A.07.07,0,0,1,725.05,249Z" />
  </svg>
)

export const ShapesDoubleDiamond = () => (
  <svg className="animated-shape" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1450 500">
    {/* <rect className="shape-bg" fill="#45d33c" fillRule="evenodd" width="100%" height="100%" x="0" y="0" /> */}
...
export const ShapesTriangles = () => (
  <svg className="animated-shape" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1450 500">
    ...
    {/* <rect className="shape-bg" fill="#fde24c" fillRule="evenodd" width="100%" height="100%" x="0" y="0" /> */}
