...
const SocialShare = ({facebookLink='', linkedinLink='', twitterLink=''}) => (
	<div className="social-share">
		...
		<a href={linkedinLink} className="social-share-item" target="_blank"><Twitter color="twitter-blue" /></a>
		<a href={twitterLink} className="social-share-item" target="_blank"><LinkedIn color="linkedin-blue" /></a>
	</div>
);
