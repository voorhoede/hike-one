...
const Team = ({ tab, TeamOverviewData, TeamMembersData, fontsLoaded, fullUrl}) => {
	return (
...
Team.getInitialProps = async ({req, query, asPath}) => {
	...
	const [TeamOverviewData, TeamMembersData] = await fetchAll([
		`team`,
		`people`
	]);
	return { tab, TeamOverviewData, TeamMembersData, fontsLoaded };
};
